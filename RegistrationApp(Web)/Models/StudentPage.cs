...
namespace RegistrationApp_Web_.Models
{
    public class StudentPage
    {
        ...
        public bool ConflictingCourse(int courseId)
        {
            ...
            foreach (iCourse someCourse in Courses)
            {
        ...
        private bool SetCourses()
        {
            ...
            bool check = false;
            string qry = $"SELECT * FROM Course INNER JOIN Student_Course ON Course.CourseId = Student_Course.CourseId WHERE Student_Course.StudentId = {StudentId}";
        ...
        public bool RemoveCourse(int student, int course)
        {
            bool updated = false;
